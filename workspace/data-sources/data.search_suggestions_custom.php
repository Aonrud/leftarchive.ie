<?php
	...
	Class datasourcesearch_suggestions_custom extends Datasource{
		...
		public function about(){
			return array(
					'name' => 'Search Index Suggestions Custom',
					'author' => array(
							'name' => 'Nick Dunn',
		...
		/*-----------------------------------------------------------------------*/
			...
			// Remove words with special characters (strips stray bits of markdown, or punctuation-seperated words)	
			foreach($words as $key => $value) {
				if (preg_match('/[\[\]\.\^\(\)]+/', $value['keyword'])) { //matches - [ ] . ^ ( )
