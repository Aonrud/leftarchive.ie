...
<xsl:template name="icon-pocketcasts">
	...
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon">
		<path d="M0,0H24V24H0Z" fill="none" />
		<path d="M2,12a10,10,0,0,1,20,0H19.5A7.5,7.5,0,1,0,12,19.5V22A10,10,0,0,1,2,12Zm10,6a6,6,0,1,1,6-6H15.83A3.83,3.83,0,1,0,12,15.83h0Z" fill-rule="evenodd" fill="{$colour}" />
	</svg>
</xsl:template>
