...
class datasourcearticles_intro extends SectionDatasource
{
    ...
    public function __construct($env = null, $process_params = true)
    {
        ...
        $this->_dependencies = array('$ds-organisation-single.system-id', '$ds-article-single.associated', '$ds-subject-single.system-id', '$ds-subjects-included.system-id');
    }
    ...
    public function about()
    {
        return array(
            ...
            'release-date' => '2022-04-25T08:36:13+00:00'
        );
    }
